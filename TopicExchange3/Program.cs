...
/// bizler Order için gelen mesajları dinleyeceğiz. o sebeple arada product olan route u yazıyoruz. 
/// Şimdi nasıl bir route u dinlemek istiyorum ben ? ortası Order olan ı dinle. 
channel.QueueBind(queue: quequeName, exchange: "TopicExchange", routingKey: "*.Order.*", arguments: null);
