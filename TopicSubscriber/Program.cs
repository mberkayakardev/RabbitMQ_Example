...
/// bizler Stock için gelen mesajları dinleyeceğiz. o sebeple arada product olan route u yazıyoruz. 
/// Şimdi nasıl bir route u dinlemek istiyorum ben ? ortası stock olan ı dinle. 
channel.QueueBind(queue:  quequeName, exchange: "TopicExchange", routingKey: "*.Stock.*", arguments:null);
